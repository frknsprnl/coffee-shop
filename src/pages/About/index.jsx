        ...
        <div className="w-5/6 md:w-3/6 text-white">
          ...
          <div className="flex flex-col justify-center">
            ...
            <span className="text-sm md:text-base">
              ...
              kilogram başında <span className="font-bold">23,2 gram</span> kafein oranıyla rakiplerinin çok ötesinde, dünyanın en yüksek kafein oranına sahip kahvesi olarak
              zirvede bulunuyor. Bu test sürecini detaylıca öğrenmek için linke
              tıklayabilirsiniz.
            </span>
            ...
            <span className="text-sm md:text-base mt-4">
              ...
              kimyasal işlem görmeyen ve katkı maddesi içermeyen The Coffee <span className="font-bold">%100 doğal </span> 
          ...
          <h1 className="text-2xl md:text-3xl text-center mt-8 mb-4">Kafein Oranı</h1>
          <div className="flex flex-col justify-center">
            <span className="text-sm md:text-base">
            Yüksek kafein oranını rahat bir içimle sunduğumuz The Coffee’mizi uzun bir kavrum maratonu sonrası 25 farklı çekirdeğin arasından denediğimiz harmanlar sonrası belirledik. Güney Amerika - Pasifik harmanına karar verildi. Kuruluşundan bu yana içilen 5 milyon fincan The Coffee sonucunda ise içenlerden yüksek kafeinin etkisi ve bu kafein oranına rağmen lezzeti ve rahat içim sunmasının verdiği şaşkınlık yapılan yorumların çok büyük bir kısmını oluşturdu.
            </span>

            <img className="my-6 md:px-36" src={caffeineTable} alt="" />

            <span className="text-sm md:text-base mt-4">Standart filtre kahvelerin kafein oranı %1 iken, The Coffee’nin kafein oranı son yapılan test sonucuna göre %2,32. Kısa bir hesapla bir fincan filtre kahveden alacağınız kafein miktarı 150 mg iken The Coffee’den yapılmış bir fincan filtre kahvede bu miktar 350 mg’lara yaklaşıyor.</span>
          </div>
        </div>
      </div>
    </div>
