        ...
        <div className="flex flex-col md:flex-row h-[36rem] w-full px-6">
          <div className="text-white mt-6 w-full px-8 flex md:flex-1 flex-col text-center md:text-left">
            ...
            <div className="flex-auto mt-8">
              <button className="text-lg md:text-2xl px-6 py-4 rounded-full shadow-lg shadow-[#cda154] md:shadow-2xl md:shadow-[#cda154] hover:text-[#cda154] hover:shadow-white ">
                Ürünleri incele
              </button>
            </div>
          </div>
